...
var leftHTML='<div class="sidebar-section"><h3 class="sidebar-title">Categorias</h3><ul class="sidebar-menu" id="categories-list"><li>Carregando...</li></ul></div><div class="sidebar-section"><h3 class="sidebar-title">Clima</h3><div class="weather-widget" id="weather-widget"><div id="weather-time" class="weather-time"></div><div id="weather-content"><div class="weather-icon">&#9728;&#65039;</div><div class="weather-temp">Carregando...</div><div class="weather-condition"></div></div></div></div><div class="sidebar-section"><h3 class="sidebar-title">Tech News</h3><ul class="sidebar-menu" id="tech-news-list"><li>Carregando...</li></ul></div>';
