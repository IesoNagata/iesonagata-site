...
var leftHTML='<div class="sidebar-section"><h3 class="sidebar-title">Servidores Aeromad</h3><ul class="sidebar-menu server-widget" id="server-widget"><li>Carregando...</li></ul></div><div class="sidebar-section"><h3 class="sidebar-title">Categorias</h3><ul class="sidebar-menu" id="categories-list"><li>Carregando...</li></ul></div><div class="sidebar-section"><h3 class="sidebar-title">Tech News</h3><ul class="sidebar-menu" id="tech-news-list"><li>Carregando...</li></ul></div>';
...
function updateServerStatus(){
  ...
  var servers=[
    ...
    {name:"666th Aeromad Company Brasil Oficial - Faircroft Islands Conflict PvE",id:"38381095",scenario:"Faircroft Islands Conflict PvE"}
  ];
  if(servers.length===0){
    sw.innerHTML='<li><span class="offline-dot"></span> Não encontrados</li>';
    return;
  }
  var html='<li><span class="online-dot"></span> <strong>ONLINE</strong> ('+servers.length+')</li>';
  servers.forEach(function(s){
    html+='<li><a href="https://www.battlemetrics.com/servers/reforger/'+s.id+'" target="_blank">'+s.name+'</a><div class="server-scenario">'+s.scenario+'</div></li>';
  });
  sw.innerHTML=html;
}
updateServerStatus();
